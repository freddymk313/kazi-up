  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-white">
      ...
      >
        ...
        <div className="relative justify-between z-10">
          <div>
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-white leading-tight mb-6">
              Rejoignez la nouvelle génération de{" "}
              <span className="text-primary italic">talents</span> en RDC.
            </h2>
          </div>

          <div className="space-y-4 mt-12 justify-end">
            {[
        ...
        >
          <div className="text-center md:text-left">
            <h1 className="text-3xl font-bold tracking-tight text-foreground mb-2">
              Créer un <span className="text-primary italic">compte</span>
            </h1>
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-sm font-medium text-muted-foreground border-r pr-2">
                  +243
                </span>
                <Input
                  id="phone"
                  ...
                  className="rounded-xl h-12 pl-16"
                />
              </div>
            </div>
            ...
            <Button
              // className="w-full h-12 rounded-xl bg-primary hover:bg-primary/90 text-white font-bold text-lg mt-6 shadow-lg shadow-primary/20 group"
