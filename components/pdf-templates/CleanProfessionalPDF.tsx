...
import { ExperienceItem, EducationItem, SkillsGrid } from "./PDFLayoutComponents";

const ACCENT = "#f3f3f3";

const styles = StyleSheet.create({
  page: { backgroundColor: "#ffffff", paddingTop: 44, paddingBottom: 36, paddingHorizontal: 48 },
  name: { fontSize: 24, fontFamily: HEADING_FONT, fontWeight: 700, textTransform: "uppercase", letterSpacing: 5, color: "#1a1a1a" },
  jobTitle: { fontSize: 14, fontFamily: BODY_FONT, color: "#666666", marginTop: 3, marginBottom: 16 },
  contactRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: "#f3f3f3", paddingVertical: 6, paddingHorizontal: 10, gap: 12, marginBottom: 24 },
  ...
  sectionDivider: { borderTopWidth: 1, borderTopColor: "#1a1a1a", marginBottom: 10 },
  ...
  skillText: { fontSize: 9.5, fontFamily: BODY_FONT, color: "#333333", textTransform: "capitalize" },
  bottomLine: { borderTopWidth: 1, borderTopColor: "#1a1a1a", marginTop: "auto" },
});
