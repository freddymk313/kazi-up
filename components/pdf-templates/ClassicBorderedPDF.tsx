...
import { ExperienceItem, EducationItem } from "./PDFLayoutComponents";
...
const styles = StyleSheet.create({
  ...
  skillBullet: { fontSize: 9, color: "#333333" },
  skillText: { fontSize: 9.5, fontFamily: BODY_FONT, color: "#404040", textTransform: "capitalize", },
});
              ...
              {education.map((edu) => (
                <View key={edu.id} style={styles.entryRow} wrap={false}>
                  ...
                  <View style={styles.entryRight}>
                    ...
                    {edu.location && (
                      <Text style={styles.entryDesc}>{edu.location}</Text>
                    )}
                  </View>
                </View>
              ))}
