...
const styles = StyleSheet.create({
  ...
  contactText: { fontSize: 9.5, color: "#404040" },
  educationItem: { marginBottom: 15 },
  eduSchool: { fontSize: 10.5, fontFamily: "Helvetica-Bold", color: "#1a1a1a" },
  eduDegree: { fontSize: 9.5, color: "#737373", marginTop: 2 },
  eduDate: { fontSize: 8.5, color: "#a3a3a3", marginTop: 2 },
  skillItem: {
    fontSize: 9.5,
    color: "#404040",
    marginBottom: 6,
  ...
  expDate: { fontSize: 8.5, color: "#a3a3a3", textTransform: "uppercase" },
  expCompany: {
    fontSize: 9.5,
    color: "#737373",
    fontFamily: "Helvetica-Bold",
  ...
  bulletDot: { width: 10, fontSize: 9, color: "#404040" },
              ...
              <View style={styles.sectionBlock}>
                ...
                {data.languages.map((l, i) => (
                  <View key={i}>
                    ...
                    <Text style={styles.skillItem}>{l}</Text>
                  </View>
                ))}
              </View>
            )}
            ...
            {certifications.length > 0 && (
              <View style={styles.sectionBlock}>
                ...
                {data.certifications.map((c, i) => (
                  <View key={i}>
                    <Text style={styles.skillItem}>{c}</Text>
                  </View>
                ))}
              </View>
            )}
